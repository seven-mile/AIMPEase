...
/* IAIMPTaskOwner */
class __declspec(uuid("41494D50-5461-736B-4F77-6E6572320000"))
IAIMPTaskOwner: public IUnknown
{
	public:
...
/* IAIMPTask */
class __declspec(uuid("41494D50-5461-736B-3200-000000000000"))
IAIMPTask: public IUnknown
{
	public:
...
/* IAIMPTaskPriority */
class __declspec(uuid("41494D50-5461-736B-5072-696F72697479"))
IAIMPTaskPriority: public IUnknown
{
	public:
...
/* IAIMPServiceThreads */
class __declspec(uuid("41494D50-5372-7654-6872-656164730000"))
IAIMPServiceThreads: public IUnknown
{
	public:
