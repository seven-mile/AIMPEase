...
class __declspec(uuid("41494D50-4C79-7269-6373-46696C650000"))
IAIMPLyrics: public IAIMPPropertyList
{
	public:
...
class __declspec(uuid("41494D50-4578-744C-7972-697850727600"))
IAIMPExtensionLyricsProvider: public IUnknown
{
	public:
...
/* IAIMPServiceLyrics */
class __declspec(uuid("41494D50-5372-764C-7972-697800000000"))
IAIMPServiceLyrics: public IUnknown
{
	public:
