...
static const GUID IID_IAIMPFileSystemCustomFileCommand = { 0x1efb17dc, 0x4984, 0x4a30, { 0xb0, 0x59, 0xe2, 0x49, 0x8f, 0xfd, 0xd2, 0x7e } };
...
/* IAIMPFileInfo */
class __declspec(uuid("41494D50-4669-6C65-496E-666F00000000"))
IAIMPFileInfo: public IAIMPPropertyList
{
	public:
...
/* IAIMPVirtualFile */
class __declspec(uuid("41494D50-5669-7274-7561-6C46696C6500"))
IAIMPVirtualFile: public IAIMPPropertyList
{
	public:
...
class __declspec(uuid("1EFB17DC-4984-4A30-B059-E2498FFDD27E"))
IAIMPFileSystemCustomFileCommand : public IUnknown
{
	public:
...
class __declspec(uuid("41465343-6D64-436F-7079-32436C706264"))
IAIMPFileSystemCommandCopyToClipboard : public IUnknown 
{
	public:
...
class __declspec(uuid("41465343-6D64-4465-6C65-746500000000"))
IAIMPFileSystemCommandDelete : public IAIMPFileSystemCustomFileCommand
{
};

/* IAIMPFileSystemCommandDropSource */
class __declspec(uuid("41465343-6D64-4472-6F70-537263000000"))
IAIMPFileSystemCommandDropSource : public IUnknown
{
	public:
...
class __declspec(uuid("41465343-6D64-4669-6C65-466C64720000"))
IAIMPFileSystemCommandOpenFileFolder : public IAIMPFileSystemCustomFileCommand
{

};

/* IAIMPFileSystemCommandStreaming */
class __declspec(uuid("41465343-6D64-5374-7265-616D696E6700"))
IAIMPFileSystemCommandStreaming : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7446-696C-654578706472"))
IAIMPExtensionFileExpander: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7446-696C-65466D740000"))
IAIMPExtensionFileFormat: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7446-696C-65496E666F00"))
IAIMPExtensionFileInfoProvider: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7446-696C-65496E666F45"))
IAIMPExtensionFileInfoProviderEx: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7446-5300-000000000000"))
IAIMPExtensionFileSystem : public IAIMPPropertyList
{
...
class __declspec(uuid("41494D50-5372-7646-5300-000000000000"))
IAIMPServiceFileManager: public IUnknown
{
	// nothing
};

/* IAIMPServiceFileFormats */
class __declspec(uuid("41494D50-5372-7646-696C-65466D747300"))
IAIMPServiceFileFormats: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7646-696C-65496E666F00"))
IAIMPServiceFileInfo: public IUnknown
{
	public:
		// File Info
...
class __declspec(uuid("41494D50-5372-7646-6C49-6E66466D7400"))
IAIMPServiceFileInfoFormatter: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7646-6C49-6E66466D7455"))
IAIMPServiceFileInfoFormatterUtils: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7646-696C-655374726D00"))
IAIMPServiceFileStreaming: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7646-5300-000000000000"))
IAIMPServiceFileSystems : public IUnknown
{
	public:
...
/* IAIMPServiceFileURI */
class __declspec(uuid("41494D50-5372-7646-696C-655552490000"))
IAIMPServiceFileURI: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7646-696C-655552493200"))
IAIMPServiceFileURI2 : public IAIMPServiceFileURI
{
	public:
