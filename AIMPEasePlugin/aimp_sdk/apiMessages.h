...
/* IAIMPMessageHook */
class __declspec(uuid("FC6FB524-A959-4089-AA0A-EA40AB7374CD"))
IAIMPMessageHook: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-764D-7367-447370720000"))
IAIMPServiceMessageDispatcher: public IUnknown
{
	public:
