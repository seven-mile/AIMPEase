...
class __declspec(uuid("41494D50-4874-7470-436C-744576747300"))
IAIMPHTTPClientEvents: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4874-7470-436C-744576747332"))
IAIMPHTTPClientEvents2: public IUnknown
{
	public:
...
class __declspec(uuid("4941494D-5053-7276-436F-6E6E43666700"))
IAIMPServiceConnectionSettings: public IAIMPPropertyList
{
};

/* IAIMPServiceHTTPClient */
class __declspec(uuid("41494D50-5372-7648-7474-70436C740000"))
IAIMPServiceHTTPClient: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7648-7474-70436C743200"))
IAIMPServiceHTTPClient2: public IUnknown
{
	public:
