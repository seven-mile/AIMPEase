...
/* IAIMPCore */
class __declspec(uuid("41494D50-436F-7265-0000-000000000000"))
IAIMPCore: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7641-7474-724F626A7300"))
IAIMPServiceAttrObjects: public IUnknown
{
	public:
		virtual HRESULT WINAPI CreateObject(REFIID IID, void **Obj) = 0;
};
...
class __declspec(uuid("41494D50-5372-7641-7474-724578740000"))
IAIMPServiceAttrExtendable: public IUnknown
{
	public:
...
/* IAIMPServiceConfig */
class __declspec(uuid("41494D50-5372-7643-6667-000000000000"))
IAIMPServiceConfig: public IAIMPConfig
{
	public:
...
class __declspec(uuid("41494D50-5372-7653-6875-74646F776E00"))
IAIMPServiceShutdown: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-7656-6572-496E666F0000"))
IAIMPServiceVersionInfo: public IUnknown
{
	public:
