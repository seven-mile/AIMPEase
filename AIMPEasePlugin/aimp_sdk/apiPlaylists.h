...
/* IAIMPPlaylistItem */
class __declspec(uuid("41494D50-506C-7349-7465-6D0000000000"))
IAIMPPlaylistItem: public IAIMPPropertyList
{
	public:
...
/* IAIMPPlaylistGroup */
class __declspec(uuid("41494D50-506C-7347-726F-757000000000"))
IAIMPPlaylistGroup: public IAIMPPropertyList
{
	public:
...
class __declspec(uuid("41494D50-506C-734C-7374-6E7200000000"))
IAIMPPlaylistListener: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-506C-734C-7374-6E7232000000"))
IAIMPPlaylistListener2: public IUnknown
{
	public:
...
/* IAIMPPlaylist */
class __declspec(uuid("41494D50-506C-7300-0000-000000000000"))
IAIMPPlaylist: public IUnknown
{
	public:
		// Adding
...
/* IAIMPPlaylistQueue */
class __declspec(uuid("41494D50-506C-7351-7565-756500000000"))
IAIMPPlaylistQueue: public IUnknown
{
	public:
		// Adding
...
class __declspec(uuid("41494D50-506C-7351-7565-75654C737400"))
IAIMPPlaylistQueueListener: public IUnknown
{
	public:
...
/* IAIMPPlaylistQueue2 */
class __declspec(uuid("41494D50-506C-7351-7565-756532000000"))
IAIMPPlaylistQueue2: public IAIMPPlaylistQueue
{
	public:
		// Listener
...
class __declspec(uuid("41494D50-536D-504C-4D6E-677200000000"))
IAIMPPlaylistPreimageListener : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-536D-504C-5372-630000000000"))
IAIMPPlaylistPreimage: public IAIMPPropertyList
{
	public:
...
class __declspec(uuid("41494D50-536D-506C-7344-617461507276"))
IAIMPPlaylistPreimageDataProvider : public IUnknown 
{
	public:
...
class __declspec(uuid("41494D50-536D-504C-5372-63466C647273"))
IAIMPPlaylistPreimageFolders : public IAIMPPlaylistPreimage
{
	public:
...
class __declspec(uuid("41494D50-4578-7450-6C73-4D616E4C7472"))
IAIMPExtensionPlaylistManagerListener: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4578-7453-6D50-6C7346637400"))
IAIMPExtensionPlaylistPreimageFactory : public IUnknown 
{
	public:
...
class __declspec(uuid("41494D50-5372-7650-6C73-4D616E000000"))
IAIMPServicePlaylistManager: public IUnknown
{
	public:
		// Creating Playlist
...
class __declspec(uuid("41494D50-536D-504C-4D6E-677232000000"))
IAIMPServicePlaylistManager2 : public IAIMPServicePlaylistManager 
{
	public:
