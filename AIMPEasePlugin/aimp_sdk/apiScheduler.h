...
/* IAIMPSchedulerEvent */
class __declspec(uuid("41494D50-5363-6865-6475-6C6572457674"))
IAIMPSchedulerEvent: public IAIMPPropertyList
{
	// nothing
};

/* IAIMPServiceScheduler */
class __declspec(uuid("41494D50-5372-7653-6368-6564756C6572"))
IAIMPServiceScheduler: public IUnknown
{
	public:
