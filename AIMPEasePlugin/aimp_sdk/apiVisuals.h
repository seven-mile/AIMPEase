...
class __declspec(uuid("41494D50-4578-7443-7374-6D5669730000"))
IAIMPExtensionCustomVisualization: public IUnknown
{
		// Common Information
...
class __declspec(uuid("41494D50-4578-7445-6D62-645669730000"))
IAIMPExtensionEmbeddedVisualization: public IUnknown
{
	public:
		// Common Information
		virtual int WINAPI GetFlags() = 0;
...
/* IAIMPServiceVisual */
class __declspec(uuid("41494D50-5372-7656-6973-75616C000000"))
IAIMPServiceVisualizations: public IUnknown
{
};
