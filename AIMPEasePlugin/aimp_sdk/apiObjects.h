...
/* IAIMPHashCode */
class __declspec(uuid("41494D50-4861-7368-436F-646500000000"))
IAIMPHashCode: public IUnknown
{
	public:
...
/* IAIMPDPIAware */
class __declspec(uuid("41494D50-4450-4941-7761-726500000000"))
IAIMPDPIAware: public IUnknown
{
	public:
...
/* IAIMPObjectList */
class __declspec(uuid("41494D50-4F62-6A4C-6973-740000000000"))
IAIMPObjectList: public IUnknown
{
	public:
...
/* IAIMPString */
class __declspec(uuid("41494D50-5374-7269-6E67-000000000000"))
IAIMPString: public IUnknown
{
	public:
...
/* IAIMPStream */
class __declspec(uuid("41494D50-5374-7265-616D-000000000000"))
IAIMPStream: public IUnknown
{
	public:
...
/* IAIMPFileStream */
class __declspec(uuid("41494D50-4669-6C65-5374-7265616D0000"))
IAIMPFileStream: public IAIMPStream
{
	public:
...
/* IAIMPMemoryStream */
class __declspec(uuid("41494D50-4D65-6D53-7472-65616D000000"))
IAIMPMemoryStream: public IAIMPStream
{
	public:
...
/* IAIMPErrorInfo */
class __declspec(uuid("41494D50-4572-7249-6E66-6F0000000000"))
IAIMPErrorInfo: public IUnknown
{
	public:
...
/* IAIMPImage */
class __declspec(uuid("41494D50-496D-6167-6500-000000000000"))
IAIMPImage: public IUnknown
{
	public:
...
/* IAIMPImage2 */
class __declspec(uuid("41494D50-496D-6167-6532-000000000000"))
IAIMPImage2: public IAIMPImage
{
	public:
...
/* IAIMPImageContainer */
class __declspec(uuid("41494D50-496D-6167-6543-6F6E746E7200"))
IAIMPImageContainer: public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5072-6F67-7265-737343420000"))
IAIMPProgressCallback: public IUnknown
{
	public:
...
/* IAIMPPropertyList */
class __declspec(uuid("41494D50-5072-6F70-4C69-737400000000"))
IAIMPPropertyList: public IUnknown
{
	public:
...
/* IAIMPPropertyList2 */
class __declspec(uuid("41494D50-5072-6F70-4C69-737432000000"))
IAIMPPropertyList2: public IAIMPPropertyList
{
	public:
...
/* IAIMPConfig */
class __declspec(uuid("41494D50-436F-6E66-6967-000000000000"))
IAIMPConfig: public IUnknown
{
	public:
		// Delete
