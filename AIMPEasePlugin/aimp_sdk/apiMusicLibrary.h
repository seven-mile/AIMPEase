...
/* IAIMPMLDataField */
class __declspec(uuid("41494D50-4D4C-4461-7461-466C64000000"))
IAIMPMLDataField : public IAIMPPropertyList
{
};

/* IAIMPMLDataFieldDisplayValue */
class __declspec(uuid("41494D50-4D4C-4461-7461-466C6444566C"))
IAIMPMLDataFieldDisplayValue : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-466C-6446-6C7400000000"))
IAIMPMLDataFieldFilter : public IAIMPPropertyList2
{
};

/* IAIMPMLDataFieldFilterByArray */
class __declspec(uuid("41494D50-4D4C-466C-6446-6C7441727200"))
IAIMPMLDataFieldFilterByArray : public IAIMPPropertyList2
{
	public:
...
class __declspec(uuid("41494D50-4D4C-466C-7447-727000000000"))
IAIMPMLDataFilterGroup : public IAIMPPropertyList2
{
	public:
...
/* IAIMPMLDataFilter */
class __declspec(uuid("41494D50-4D4C-4669-6C74-657200000000"))
IAIMPMLDataFilter : public IAIMPMLDataFilterGroup
{
	public:
...
/* IAIMPMLFileList */
class __declspec(uuid("41494D50-4D4C-4669-6C65-4C6973740000"))
IAIMPMLFileList : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-536F-7274-446972746E00"))
IAIMPMLSortDirection: public IUnknown
{
	public:
...
// Commands
//----------------------------------------------------------------------------------------------------------------------
class __declspec(uuid("41494D50-4D4C-4453-436D-644164640000"))
IAIMPMLDataStorageCommandAddFiles : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-436D-644164644400"))
IAIMPMLDataStorageCommandAddFilesDialog : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-436D-6444656C0000"))
IAIMPMLDataStorageCommandDeleteFiles : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-436D-6444656C3200"))
IAIMPMLDataStorageCommandDeleteFiles2 : public IAIMPMLDataStorageCommandDeleteFiles
{
	public:	
...
class __declspec(uuid("41494D50-4D4C-4453-436D-6444726F7000"))
IAIMPMLDataStorageCommandDropData : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-436D-645570546167"))
IAIMPMLDataStorageCommandReloadTags : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-436D-645270727400"))
IAIMPMLDataStorageCommandReportDialog : public IUnknown
{
	public:
		virtual HRESULT WINAPI Execute(HWND OwnerHandle) = 0;
};
...
class __declspec(uuid("41494D50-4D4C-4453-436D-644D61726B00"))
IAIMPMLDataStorageCommandUserMark : public IUnknown
{
	public:
...
class __declspec(uuid("414D4C53-6D50-6C73-5372-630000000000"))
IAIMPMLPlaylistPreimage : public IAIMPPlaylistPreimage
{
	public:
...
class __declspec(uuid("41494D50-4D4C-416C-6241-727450727600"))
IAIMPMLAlbumArtProvider : public IUnknown
{
	public:
...
/* IAIMPMLDataProvider */
class __declspec(uuid("41494D50-4D4C-4461-7461-507276000000"))
IAIMPMLDataProvider : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4461-7461-507276320000"))
IAIMPMLDataProvider2 : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4461-7461-50727653656C"))
IAIMPMLDataProviderSelection : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4770-5472-656553656C00"))
IAIMPMLGroupingTreeSelection : public IUnknown
{
	public:
		virtual int WINAPI GetCount() = 0;
...
class __declspec(uuid("41494D50-4D4C-4772-4474-50727653656C"))
IAIMPMLGroupingTreeDataProviderSelection : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4772-7044-617461507276"))
IAIMPMLGroupingTreeDataProvider : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4772-7050-737400000000"))
IAIMPMLGroupingPreset : public IAIMPPropertyList
{
};

/* IAIMPMLGroupingPresetStandard */
class __declspec(uuid("41494D50-4D4C-4772-7050-737453746400"))
IAIMPMLGroupingPresetStandard: public IAIMPMLGroupingPreset
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4772-5072-737473000000"))
IAIMPMLGroupingPresets : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-4D4C-4453-4D6E-677200000000"))
IAIMPMLDataStorageManager : public IUnknown
{
	public:
...
/* IAIMPMLDataStorage */
class __declspec(uuid("41494D50-4D4C-4461-7461-537467000000"))
IAIMPMLDataStorage : public IAIMPPropertyList // + IAIMPMLGroupingPresets
{
};

/* IAIMPMLDataStorage2 */
class __declspec(uuid("41494D50-4D4C-4461-7461-537467320000"))
IAIMPMLDataStorage2 : public IAIMPMLDataStorage // + IAIMPMLDataProvider, IAIMPMLDataProvider2
{
	public:
...
class __declspec(uuid("41494D50-4578-744D-4C44-530000000000"))
IAIMPMLExtensionDataStorage : public IAIMPPropertyList // + IAIMPMLDataProvider
{
	public:
...
class __declspec(uuid("41494D50-5372-764D-4C00-000000000000"))
IAIMPServiceMusicLibrary : public IUnknown
{
	public:
...
class __declspec(uuid("41494D50-5372-764D-4C55-490000000000"))
IAIMPServiceMusicLibraryUI : public IUnknown
{
	public:
